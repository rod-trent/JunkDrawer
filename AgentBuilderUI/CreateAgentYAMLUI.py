...
def generate_agent_yaml(prompt):
...
# Streamlit app
st.title("CrewAI Agent YAML Generator")

# Input for the prompt
prompt = st.text_input("Enter the prompt describing the agent (e.g., 'Create a researcher agent for AI news'):")

if st.button("Generate YAML"):
    if prompt:
        try:
            generated_yaml = generate_agent_yaml(prompt)
