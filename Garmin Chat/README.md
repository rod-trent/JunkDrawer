...
2. **The Gradio interface will open in your browser automatically** (usually at `http://127.0.0.1:7860`)

3. **Click "Connect to Garmin"** to authenticate with your Garmin Connect account

4. **Start chatting!** Ask questions about your fitness data:
...
- Uses `grok-2-1212` model by default
