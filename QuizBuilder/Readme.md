...
Get your quiz game up and running in 3 minutes!
...
## Step 3: Create Your First Quiz (1 minute)

### Important: Admin Panel is Password Protected
- **Default Password:** `admin123`
- **⚠️ Change this password in the code before deploying!**
- See SECURITY.md for password management details

### Option A: Use the Sample File
1. Go to the **Admin Panel** tab
2. Enter password: `admin123` and click **Login**
3. Enter a game title like "General Knowledge Quiz"
4. Upload `sample_quiz_qa_format.xlsx` (provided)
5. Click **Generate Quiz Game**

### Option B: Use Your Own File
1. Go to the **Admin Panel** tab
2. Enter password: `admin123` and click **Login**
3. Enter a game title
4. Upload your Excel/Word/JSON/CSV file
5. Click **Generate Quiz Game**

## Step 4: Play the Quiz (1 minute)

1. Go to the **Play Quiz** tab
2. Select your game from the dropdown
3. Enter your name
4. Answer the questions
5. See your score and leaderboard position!
...
- `Option A`, `Option B`, `Option C`, `Option D` - Multiple choice options (optional)

Example:
| Question | Answer | Option A | Option B | Option C | Option D |
|----------|--------|----------|----------|----------|----------|
| What is 2+2? | 4 | 3 | 4 | 5 | 6 |

### Excel Structured Data
Any structured data works! The app generates questions automatically:
- Schedules/Agendas
- Product catalogs
...
[
  {
    ...
    "options": ["JavaScript Object Notation", "Java Source Object Notation", "Just Simple Object Names", "None of these"]
  }
]
```
...
1. **Excel Files**: Use clear column headers like "Question" and "Answer"
2. **Word Files**: Start questions with "Q:" and answers with "A:"
3. **Structured Data**: Any organized data works - the app is smart!
4. **File Size**: Keep files under 10MB for best performance
5. **Question Count**: 5-50 questions per game works best

## Common Issues

**No questions generated?**
- Check your file format matches the examples above
- Make sure there's actual content in your file
- Try the sample file first to test

**Can't see my game?**
- Refresh the page after creating a game
- Check the Admin Panel to see all games
...
- **IMPORTANT**: Change the admin password (see SECURITY.md)
- Upload different file types to see how the app adapts
- Challenge colleagues to beat your score
- Create multiple quiz games for different topics
- Check the full README.md for advanced features

## Security Reminder 🔒

The Admin Panel is password-protected with default password: `admin123`

**Before sharing or deploying:**
1. Open `quiz_game_app.py`
2. Find `ADMIN_PASSWORD = "admin123"` near the top
3. Change to a secure password
4. Save and restart the app

See **SECURITY.md** for detailed password management instructions.
